...
# Récupération de la thématique la plus probable
...
**Exercice** : Completer le code ci dessous pour estimer le model de la LDA, récupérer les p(t=i\|d_j) (gamma), récupérer les p(w\|t) (betas), et lister les 15 mots les plus communs par thème et barplots .
...
```{r}
# On récupère uniqument le tableau des gammas sans la colonne "document"
